...
namespace VDVT.Order.Services.Api.Controllers
{
    ...
    public class OrderApiController : ControllerBase
    {
        ...
        public OrderApiController(ResponseDto response, IMapper mapper, AppDbContext appDbContext, IProductoService productoService, IConfiguration configuration)
        {
        ...
        public ResponseDto Get(int id)
        {
            try
            {
                OrderHeader orderHeader = _appDbContext.OrderHeaders.Include(_u => _u.OrderDetailsDto)
